...
export function IconWhatsApp({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M12.04 2a9.94 9.94 0 0 0-8.48 15.22L2 22l4.89-1.5A9.94 9.94 0 1 0 12.04 2Zm0 1.8a8.14 8.14 0 0 1 6.84 12.5l.15.25-1.2 3.45 3.57-1.05.24.16A8.14 8.14 0 1 1 12.04 3.8Zm4.43 11.44c-.24-.12-1.43-.71-1.65-.79s-.38-.12-.54.12-.62.79-.76.95-.28.18-.52.06a6.46 6.46 0 0 1-1.89-1.17 7.12 7.12 0 0 1-1.31-1.62c-.14-.24 0-.37.1-.49s.24-.27.36-.41a1.54 1.54 0 0 0 .24-.41.46.46 0 0 0 0-.46c0-.12-.54-1.31-.74-1.79s-.39-.41-.54-.42h-.46a.89.89 0 0 0-.64.29c-.22.24-.84.82-.84 2s.86 2.3 1 2.46 1.72 2.62 4.17 3.67 2.46 1 2.9.94 1.43-.55 1.64-1.08.23-1 .16-1.08-.24-.16-.54-.28Z" />
    </svg>
  );
}
...
export function IconPhone({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M6.6 10.8a15.9 15.9 0 0 0 6.6 6.6l2.2-2.2a1 1 0 0 1 1-.24 11.4 11.4 0 0 0 3.6.6 1 1 0 0 1 1 1V21a1 1 0 0 1-1 1A17 17 0 0 1 3 5a1 1 0 0 1 1-1h3.5a1 1 0 0 1 1 1c0 1.25.2 2.45.6 3.6a1 1 0 0 1-.24 1l-2.26 2.2Z" />
    </svg>
  );
}
...
export function IconShield({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M12 3 4.5 6v6.2c0 4.4 3.1 8 7.5 8.8 4.4-.8 7.5-4.4 7.5-8.8V6L12 3z" />
...
export function IconChat({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M21 12a8 8 0 1 1-3.2-6.4L21 4l-1 4-4 1 1.6-1.6A8 8 0 0 1 21 12z" />
...
export function IconTikTok({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M14 4c.5 2.5 2.5 4.5 6 4.5" />
    </svg>
  );
}
...
export function IconHeart({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M12 21s-7-4.35-7-10a4.5 4.5 0 0 1 8-3 4.5 4.5 0 0 1 8 3c0 5.65-7 10-9 10z" />
    </svg>
  );
}
